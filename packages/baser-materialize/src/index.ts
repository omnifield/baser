 ...
 *
 * **Предупреждение обвеса движок НЕСЁТ, а не считает** (`tasker:BASER2-226`,
 * `lib/warning.ts`). Резолвер живёт в пакете обвеса, зовёт его дверь; движок
 * кладёт посчитанное состояние в план, потому что план — машинный ответ прогона,
 * и без этого предупреждение не увидели бы ни пульт, ни агент (`kb:BASER3-33`).
 * Правило «вход подаётся готовой структурой» этим не нарушено, а исполнено.
 *
