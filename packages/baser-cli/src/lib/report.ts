 ...
 *
 * Адресность у предупреждения та же, что у блока: пересборка предстоит там, где
 * переписывается уже лежащий артефакт. На первой укладке пересоздавать нечего —
 * и предупреждения нет, иначе оно приклеилось бы к каждому применению и за
 * неделю перестало бы читаться.
 */
