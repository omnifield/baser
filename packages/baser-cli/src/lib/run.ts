  ...
  return config.existed
    ? {
        ...
        message:
          ...
          'поимённо (--confirm) — твоя версия будет заменена целиком СБОРКОЙ ОТ ' +
          'ДЕФОЛТОВ обвеса и его файла настроек, из твоего файла не переедет ничего, ' +
          'и запись родится заново',
      }
    : {
        code: 'first-install',
        ...
        message:
          ...
          'отказ заменить чужое, а не поломка. И НЕ ПРОЧИТАЛИ: то, что ляжет, ' +
