 ...
 *
 * Одно обещание: сказать про каталог распакованного обвеса, встанет он в патрон
 * или нет, и если нет — назвать ВСЕ причины сразу, кодом и адресом. Пакет
 * ничего не производит, ничего не пишет и ничего не исполняет.
 *
